...
<div class="flex-grow flex bg-arena-landscape-blurred bg-cover">
	...
	<div class="flex flex-col items-center bg-stone-400 max-w-[33vw] 2xl:max-w-[25vw] p-10 pt-12 m-16 border-[16px] border-stone-900 rounded-[32px]" style="box-shadow: 0 0 60px #000">
